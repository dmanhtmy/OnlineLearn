<%-- 
    Document   : ads
    Created on : Dec 11, 2022, 6:50:33 PM
    Author     : MrTuan
--%>
        ...
        <ul class="box-info-blog">
            <table class="table">
                ...
                <tbody>
                    ...
                    <c:forEach items="${requestScope.listAds}" var="ads">
...
<script>
    function createAds() {
        window.location.href = "<%=request.getContextPath()%>/admin/ads/create";
    }
    function updateAds(id) {
        window.location.href = "<%=request.getContextPath()%>/admin/ads/update?id=" + id;
    }
