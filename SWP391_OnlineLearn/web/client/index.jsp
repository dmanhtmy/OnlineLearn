<%-- 
    Document   : index
    Created on : 2 Dec, 2022, 12:05:58 AM
    Author     : HP
--%>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal tasi-form" method="post"  id="form-282" action="userprofile" enctype="multipart/form-data">
                    <div class="modal-body mb-3">
                        ...
                        <div class="avatar">
                            ...
                            <input type="file"  accept="image/*" name="avatar" id="imgInp">
                            <div class="avatar-img">
                                <img src="${sessionScope.user.avatar}"id="blah"  onchange="PreviewImage();" src="" style="border-radius: 1rem" width="400px" height="240px">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">EMAIL</label>
                            <input id="username" disabled="" value="${sessionScope.user.email}" type="text" name="email"class="form-control" required="" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
        ...
        <div class="col-lg-7 col-md-12">
            <div class="row">
                <div class="col-md-6 mb-5">
                    ...
                    <p><i class="fa fa-envelope mr-2"></i>onlinelearn@fpt.edu.vn</p>
...
<div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .1) !important;">
    <div class="row">
        <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
            <p class="m-0 text-white">&copy; <a href="#">OnlineLearn.com</a>. All Rights Reserved
            </p>
        </div>
