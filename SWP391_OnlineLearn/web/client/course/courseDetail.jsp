<%-- 
    Document   : detail
    Created on : 7 Dec, 2022, 12:07:00 AM
    Author     : HP
--%>
            ...
            <div class="container-fluid py-5 col-md-8">
                <div class="container py-5">
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <img class="img-fluid rounded mb-4 mb-lg-0" src="${requestScope.course.getThumbnail()}" alt="">
                        </div>
                        <div class="col-lg-7">
...
<!--                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-share-fill" viewBox="0 0 16 16">
        ...
        <div class="container-fluid px-2 pt-5 col-md-8" style="margin-top: 100px">
