<%-- 
    Document   : course1
    Created on : 6 Dec, 2022, 11:52:49 PM
    Author     : HP
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.List"%>
<%@page import="Models.CourseRegistration"%>
    ...
    <body>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                ...
                <div class="row col-md-12 search-form pb-3" >
                    <form action="course?action=search" method="" style="display: flex">
                            ...
                            <c:otherwise>
                                ...
                                <div class="col-lg-4 col-md-6 mb-4">
                                    <div class="rounded overflow-hidden mb-2">
                                        <img class="img-fluid" src="${c.thumbnail}" alt="course">
